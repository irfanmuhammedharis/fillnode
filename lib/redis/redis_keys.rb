module Redis::RedisKeys
  ...
  FILLNODE_INSTALLATION_ONBOARDING = 'FILLNODE_INSTALLATION_ONBOARDING'.freeze
  FILLNODE_INSTALLATION_CONFIG_RESET_WARNING = 'FILLNODE_CONFIG_RESET_WARNING'.freeze
  LATEST_FILLNODE_VERSION = 'LATEST_FILLNODE_VERSION'.freeze
