...
namespace :fillnode do
  namespace :dev do
    desc 'Toggle between Fillnode variants with interactive menu'
    ...
    desc 'Show current Fillnode variant status'
