import { parseBoolean } from '@fillnode/utils';
...
const {
  ...
  FILLNODE_INBOX_TOKEN: fillnodeInboxToken,
...
export const getters = {
  get: $state => $state,
  isOnFillnodeCloud: _state => false,
  isACustomBrandedInstance: _state => true,
  isAFillnodeInstance: _state => false,
};
