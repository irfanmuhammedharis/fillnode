...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Fillnode?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://fillnode.dev/invoice.pdf'),
      getAttachment('file', 'https://fillnode.dev/logs.txt'),
      getAttachment('file', 'https://fillnode.dev/contacts.xls'),
      getAttachment('file', 'https://fillnode.dev/customers.csv'),
      getAttachment('file', 'https://fillnode.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://fillnode.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://fillnode.dev/all-files.tar'),
      getAttachment(
        'audio',
