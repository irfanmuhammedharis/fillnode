...
const { t } = useI18n();
const { currentAccount, accountId, isOnFillnodeCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnFillnodeCloud.value);
const i18nKey = computed(() =>
  isOnFillnodeCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-fillnode-cloud="isOnFillnodeCloud"
