...
describe('useConfig', () => {
  const originalFillnodeConfig = window.fillnodeConfig;
  ...
  afterEach(() => {
    window.fillnodeConfig = originalFillnodeConfig;
  });
  ...
  it('handles undefined window.fillnodeConfig', () => {
    window.fillnodeConfig = undefined;
    const config = useConfig();
