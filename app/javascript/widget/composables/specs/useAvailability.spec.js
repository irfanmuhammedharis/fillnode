...
describe('useAvailability', () => {
  const originalWindow = window.fillnodeWebChannel;
  ...
  afterEach(() => {
    window.fillnodeWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.fillnodeWebChannel changes', () => {
