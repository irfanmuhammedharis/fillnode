...
const isAFillnodeInstance = computed(
  () => globalConfig.value.installationName === 'Fillnode'
);

onBeforeMount(() => {
  isLoading.value = isAFillnodeInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAFillnodeInstance }"
    >
