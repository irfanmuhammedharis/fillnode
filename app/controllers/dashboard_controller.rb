class DashboardController < ActionController::Base
  ...
  def ensure_installation_onboarding
    redirect_to '/installation/onboarding' if ::Redis::Alfred.get(::Redis::Alfred::FILLNODE_INSTALLATION_ONBOARDING)
  end
  ...
  def app_config
    {
      APP_VERSION: Fillnode.config[:version],
      ...
      IS_ENTERPRISE: FillnodeApp.enterprise?,
