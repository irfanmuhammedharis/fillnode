...
class Message < ApplicationRecord
  searchkick callbacks: false if FillnodeApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless FillnodeApp.advanced_search_allowed?
    ...
    return false if FillnodeApp.fillnode_cloud? && !account.feature_enabled?('advanced_search_indexing')
