...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if FillnodeApp.enterprise?
                                 attributes = {
                                   limits: AccountLimitsField
                                 }

                                 # Only show manually managed features in Fillnode Cloud deployment
                                 attributes[:manually_managed_features] = ManuallyManagedFeaturesField if FillnodeApp.fillnode_cloud?
  ...
  def permitted_attributes(action)
    ...
    # Add manually_managed_features to permitted attributes only for Fillnode Cloud
    attrs << { manually_managed_features: [] } if FillnodeApp.fillnode_cloud?
